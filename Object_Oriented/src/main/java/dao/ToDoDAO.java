...
public interface ToDoDAO {
     ...
     * @return Un intero rappresentante la nuova posizione (massima posizione attuale + 1).
     */
    ...
    /**
     * Sposta un task da una bacheca all'altra aggiornando il riferimento al relativo board_id.
     *
     * @param todoId        L'identificativo del task da spostare.
     * @param targetBoardId L'identificativo della bacheca di destinazione.
     * @param currentUserId L'ID del proprietario che esegue lo spostamento.
     * @return {@code true} se lo spostamento ha successo, {@code false} altrimenti.
     */
     ...
     * @return Una lista di oggetti {@link ToDo}. Restituisce una lista vuota se non ci sono task.
     */
     ...
     * @return Il percorso del file come stringa, oppure {@code null} se non esiste o non è impostato.
     */
     ...
     *
     * @param todoId L'identificativo del task.
     * @param userId L'ID dell'utente che abbandona il task.
     ...
     *
     * @param todoId L'identificativo del task.
     * @return L'oggetto {@link ToDo} trovato, oppure {@code null} se il task non esiste.
     */
     ...
     *
     * @param todoId L'identificativo del task.
     * @return Una lista di stringhe contenente i nomi utenti dei collaboratori (può essere vuota).
     */
    List<String> getCollaborators(int todoId);

    /**
     * Aggiorna la posizione numerica di un task all'interno della sua bacheca.
     * Utilizzato per gestire il riordinamento (es. tramite Drag &amp; Drop).
     *
     * @param todoId      L'identificativo del task da spostare.
     * @param newPosition Il nuovo valore dell'ordinamento.
     * @return {@code true} se l'aggiornamento ha successo, {@code false} altrimenti.
     */
